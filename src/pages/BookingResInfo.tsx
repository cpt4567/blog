export default function BookingResInfo() {
    return (
          ...
          <section className="res_info_sec">
            <div className="res_pay_area">
              <ul>
                ...
                <li>
                  <label htmlFor="tel" className="tit">차량번호</label>
                  <div className="tel_area">
          ...
          <section className="bar_sort">
            ...
            <div className="res_pay_area">
              <div className="save_div">
                <p>사용 가능 적립금 : <span className="">100,000</span>원</p>
                <div className="code_num">
                  <input type="text" pattern="[0-9]*" placeholder="인증번호를 입력해 주세요." className="inp_txt"/>
                  <button type="button" className="btn_cof">인증번호 발송</button>
                </div>
              </div>
              <ul className="lst_txt">
                <li>적립금 사용은 휴대폰 인증을 받으셔야 합니다.</li>
                <li>적립금은 <span><em>1,000</em>원</span> 단위로 사용이 가능합니다.</li>
                <li>해당 캠핑장은 적립금 <span><em>1,000</em>원</span> 이상부터 사용하실 수 있습니다.</li>
                <li>땡큐캠핑 적립금은 최대 <span><em>50,000</em>원</span>까지 사용이 가능합니다.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="bar_sort">
            ...
            <div className="info_div">
              <div className="point_div">
                ...
                <p className="price">2,000<span>원</span></p>
              </div>
              ...
              <ul className="lst_txt type2">
                ...
                <li>땡큐캠핑 적립금은 <span>숙박요금의 4%</span>, 적립은 예약일 다음날 자동 적립됩니다.</li>
              </ul>
            </div>
          </section>
              ...
              <div className="agree_box">
                <ul className="clear">
                  <li>
                    ...
                    <label htmlFor="agr1">예약 유의사항 및 취소/환불규정 동의<span>(필수)</span></label>
                  </li>
                  <li>
